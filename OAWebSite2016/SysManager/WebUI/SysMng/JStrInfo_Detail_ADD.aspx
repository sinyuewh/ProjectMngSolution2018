<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiThird.Master"
    AutoEventWireup="true" CodeBehind="JStrInfo_Detail_ADD.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.SysMng.JStrInfo_Detail_ADD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--定义数据豆-->
    <jasp:JDataBean ID="bean1" runat="server" ControlList="Num,strID,StrText,StrText1,Remark"
    ...
    <!--控制修改的权限-->
    <jasp:SecurityPanel ID="sec0" runat="server" AuthorityID="JStrInfo_ADD">
        <div class="row cl">
