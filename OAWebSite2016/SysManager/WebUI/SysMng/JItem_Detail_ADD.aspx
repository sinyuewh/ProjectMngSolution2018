<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiThird.Master" AutoEventWireup="true" CodeBehind="JItem_Detail_ADD.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.SysMng.JItem_Detail_ADD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <jasp:JDataBean ID="bean1" runat="server" DataSourceID="data1" 
         ControlList="Num,ItemName,MinValue,MaxValue,InterValue,Remark"
    ...
    <div class="row cl">
        <label class="form-label col-3">
            最小值：</label>
        <div class="formControls col-5">
            <jasp:JTextBox ID="MinValue" runat="server" Caption="最小值" DataType="Integer" class="input-text"></jasp:JTextBox>
        </div>
        <div class="col-4">
        </div>
    </div>
    ...
    <div class="row cl">
        <label class="form-label col-3">
            最大值：</label>
        <div class="formControls col-5">
            <jasp:JTextBox ID="MaxValue" runat="server" Caption="最大值" DataType="Integer" class="input-text"></jasp:JTextBox>
        </div>
        <div class="col-4">
        </div>
    </div>
    ...
    <div class="row cl">
        <label class="form-label col-3">
            值间隔：</label>
        <div class="formControls col-5">
            <jasp:JTextBox ID="InterValue" runat="server" Caption="值间隔" DataType="Integer" class="input-text"></jasp:JTextBox>
        </div>
        <div class="col-4">
        </div>
    </div>
    ...
    <div class="row cl">
        <label class="form-label col-3">
            备注：</label>
        <div class="formControls col-5">
            <jasp:JTextBox ID="Remark" runat="server" Caption="备注" class="input-text"></jasp:JTextBox>
        </div>
        <div class="col-4">
        </div>
    </div>
