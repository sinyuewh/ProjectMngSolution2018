<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetUserQx.aspx.cs" 
 MasterPageFile="~/SysManager/include/H-uiThird.Master"
Inherits="OAWebSite2016.SysManager.WebUI.SysMng.SetUserQx" %>
    ...
    <div style="margin-left:-10px">
        <jasp:SecurityPanel ID="sec0" runat="server">
           <%-- <input class="btn btn-primary radius" runat="server" id="btnSubmit" type="submit"
            ...
            <jasp:JButton ID="but1" runat ="server" Text =" 设 置 "
